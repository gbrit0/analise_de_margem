SELECT
    ...
    D3_CUSTO1 custo,
    CASE WHEN SUBSTRING(D3_CF, 1, 2) = 'RE' THEN D3_CUSTO1 ELSE D3_CUSTO1 * -1 END custo_2,
    TRIM(D3_OP) ord_producao,
    TRIM(D3_LOTECTL) lote,
    TRIM(D3_OSTEC) os_ass_tecn,
    TRIM(D3_GRUPO) grupo,
    TRIM(BM_DESC) descricao_grupo,
    ...
    TRIM(D3_CONTA) + ' - ' + TRIM(CT1_DESC01) descricao_da_conta,
    TRIM(D3_CC) centro_custo,
    TRIM(D3_CC) + ' - ' + TRIM(CTT_DESC01) desc_centro_de_custo,
