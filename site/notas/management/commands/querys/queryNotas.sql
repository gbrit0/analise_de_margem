SELECT DISTINCT
    ...
    TRY_CONVERT(DATE, NULLIF(TRIM(F2_EMISSAO), ''), 112) AS [data_emissao],
...
WHERE
    TRY_CONVERT(DATE, NULLIF(TRIM(F2_EMISSAO), ''), 112) >= '2025-09-01' -- AND '2025-09-30'
