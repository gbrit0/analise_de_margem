    ...
    try:
        with pymysql.connect(
               ...
               with con.cursor() as cursor:
                    with open('brg/querys/busca_nfs_mes_anterior.sql', 'r', encoding='utf-8') as query:
...
def busca_clientes_parceiros():
    try:
        with pymysql.connect(
                ...
                with con.cursor() as cursor:
                    with open('brg/querys/busca_clientes_parceiros.sql', 'r', encoding='utf-8') as query:
                        consulta = query.read()
...
if __name__ == '__main__':
    ...
    try:
        ...
        if nfs_mes_anterior is None or nfs_mes_anterior.empty:
            ...
            cols_to_float = ['valor_contabil', 'custo', 'valor_unitario', 'valor_ipi', 'valor_imp5', 'preco_tabela', 'valor_imp6', 'vlr_icms_difal', 'valor_icms', 'margem', 'margem_bruta', 'aliq_icms']
            ...
            nome_arquivo = f'analise_margem_brg_{mes_ano_analise}.xlsx'
            ...
            with pd.ExcelWriter(f'brg/{nome_arquivo}', engine='xlsxwriter') as writer:
                workbook = writer.book
                # ================================================================
